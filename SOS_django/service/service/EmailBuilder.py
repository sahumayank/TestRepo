...
class EmailBuilder:
    ...
    def change_password(params):
        ...
        msg+="<p><b>"+"To access account user login id: "+params.login+" Password : "+params.password+"</b><b>"
        msg+="</HTML></BODY>"
        return msg
    ...
    def forgot_password(params):
        ...
        msg+="<P><B>"+"To access account user login id: "+params.login+"<br>"+" Password: "+params.password
        msg+="</HTML></BODY>"
        return msg